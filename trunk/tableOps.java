...
public class tableOps {
    ...
    public JTable select(String column){
    ...
    public JTable selectAs(String column){
    	//this function will return a new table containing the columns
    ...
    public JTable delete(String column, String row){
